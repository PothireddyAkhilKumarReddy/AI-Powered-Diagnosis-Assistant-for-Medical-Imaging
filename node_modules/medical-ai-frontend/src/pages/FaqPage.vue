  ...
  setup() {
    ...
    const faqs = [
      ...
      },
      {
        ...
        answer: 'DiagnoBot is trained on chest X-ray images and can classify them as COVID-19, Pneumonia, or Normal. For best results, upload standard frontal chest X-rays in JPG, PNG, or GIF format.'
      },
      {
